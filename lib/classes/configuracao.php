...
abstract class Configuracao {
    ...
    function getMail_host() {
        return $this->mail_host;
    }

    function getMail_port() {
    ...
    function getMail_pass() {
        return $this->mail_pass;
    }

    function setMail_host($mail_host) {
        $this->mail_host = $mail_host;
    }

    function setMail_port($mail_port) {
        $this->mail_port = $mail_port;
    }

    function setMail_user($mail_user) {
        $this->mail_user = $mail_user;
    }

    function setMail_pass($mail_pass) {
    ...
    private function __construct() {
        ...
        $this->mail_host = $settings['email']['servidor'];
        $this->mail_port = $settings['email']['porta'];
        $this->mail_user = $settings['email']['usuario'];
        $this->mail_pass = $settings['email']['senha'];
        /*
         * 
