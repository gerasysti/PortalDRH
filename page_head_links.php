...
?>
    ...
    <!--<script type="text/javascript" src="./assets-minified/js-core.js"></script> ADICIONAL-->
    ...
    <!--<link rel="stylesheet" type="text/css" href="./assets-minified/admin-all-demo.css"> ADICIONAL-->
