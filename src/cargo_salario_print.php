...
<?php
    ...
    $tabela = file_get_contents("../downloads/TCS_{$nr_ano}{$nr_mes}_{$md5_unidade}.html");
?>
<html>
    <head>
        <?php
        ...
        <title>Remuneratu$ | DRH Transparência | Tabela de Cargos/Funções e Salários</title>
    </head>
    <body>
        <style>
            @page {
            ...
            table#tb_cargo_salario th.titulo { 
                font-size: 8px;
                background: #0a0a2a; 
            ...
            table#tb_cargo_salario th.titulo.direita { 
                text-align: right;
            }
            table#tb_cargo_salario th.titulo.esquerda { 
                text-align: left; 
            }
            table#tb_cargo_salario th.titulo.centro { 
                text-align: center;
            }
            table#tb_cargo_salario th.rodape { 
                text-align: right;
                font-size: 10px;
                background: #0a0a2a; 
                color: rgb(255, 255, 255);
            }
            table#tb_cargo_salario tr td { /* Toda a tabela com fundo Creme */
                background: #ffc;
                padding: 4px;
            ...
            table#tb_cargo_salario tr.dif td {
