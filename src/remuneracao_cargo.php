...
?>
    <body>
                ...
                <div id="page-content">
                    ...
                    <div class="col-md-12">
                        <div id="page-title">
                            <h2><strong>Consolidado de Remuneração por Cargos</strong></h2>
                                ...
                                <div class="box-wrapper">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <button id="btn_consultar" class="btn ra-round btn-primary" onclick="consultarRemuneracaoCargo('<?php echo md5($id_und);?>', '<?php echo 'unidade_' . $id_und?>')" title="Executar Consulta"><i class="glyph-icon icon-search"></i></button>
                                                <button id="btn_imprimir"  class="btn ra-round btn-primary" onclick="imprimirRemuneracaoCargo ('<?php echo md5($id_und);?>', '<?php echo 'unidade_' . $id_und?>')"  title="Baixar Consulta em PDF" disabled><i class="glyph-icon icon-file-pdf-o"></i></button>
                                                <button id="btn_exportar"  class="btn ra-round btn-primary" onclick="exportarRemuneracaoCargo ('<?php echo md5($id_und);?>', '<?php echo 'unidade_' . $id_und?>', 'arquivo_txt')"  title="Baixar Consulta em Arquivo TXT" disabled><i class="glyph-icon icon-file-text-o"></i></button>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            <div class="panel-body">
                                ...
                                <div class="box-wrapper" id="tabela-cargos">
