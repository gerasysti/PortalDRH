 ...
 */
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if (isset($_POST['ac'])) {
            switch ($_POST['ac']) {
                case 'consultar_remuneracao_vinculo' : {
                    try {
                        ...
                        $id_crg = (int)preg_replace("/[^0-9]/", "", "0".trim(filter_input(INPUT_POST, 'id_crg')));
                        
                        // Gerar arquivo HTML e TXT
                        $nm_arquivo_htm = "Renumeracao_Vinculo_" . $nr_ano . $nr_mes . "_" . md5($id_cliente) . ".html";
                        $nm_arquivo_txt = "Renumeracao_Vinculo_" . $nr_ano . $nr_mes . "_" . md5($id_cliente) . ".txt";
                        ...
                        $es = fwrite($fp_txt, "VÍNCULO|SERVIDORES|VENC. BASE|REMUNERAÇÕES|DESCONTOS|LÍQUIDOS" . "\r\n");
                        $es = fwrite($fp_htm, 
                              "<table id='tb_remunecacao' cellspacing='0' width='100%'>"
                            . " <thead>"
                            . "     <tr>"
                            . "         <th class='titulo esquerda'>Vínculo</th>"
                            . "         <th class='titulo direita'>Servidores</th>"
                            . "         <th class='titulo direita'>Venc.Base (R$)</th>"
                            . "         <th class='titulo direita'>Remunerações (R$)</th>"
                            . "         <th class='titulo direita'>Descontos (R$)</th>"
                            . "         <th class='titulo direita'>Líquidos (R$)</th>"
                            . "     </tr>"
                            . " </thead>"
                            . " <tbody>" . "\r\n");
