...
/*                        box-shadow: -5px -10px 30px #900, 6px 9px 15px #090;
                ...
                <div id="page-content">
                    ...
                    <div class="col-md-12" id="panel_titulo">
                        <div id="page-title">
                            <h2><strong>Unidades Gestoras</strong></h2>
                            <p><strong>Lista de unidades gestoras cadastrados para o cliente</strong></p>
                        </div>
                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4 padding-field">
                                                <div class="input-group">
                                                    <input type="text" class="form-control text lg-text" id="pesquisa" value="" placeholder="Caso necessário, informe a descrição da UG ..."/>
                                                    <div class="input-group-addon" style="padding: 0px; padding-left : 4px;">
                                                        <button id="btn_consultar" class="btn ra-round btn-primary lg-text" onclick="consultarUnidadeGestora('<?php echo 'id_' . $_SESSION['acesso']['id'];?>', '<?php echo 'lg_' . $_SESSION['acesso']['us']?>')" title="Executar Consulta"><i class="glyph-icon icon-search"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-md-12" id="panel_resultado">
                        <div class="panel">
                            <div class="panel-body">
                                ...
                                <div class="box-wrapper" id="tabela-unidades_gestoras">
                                    &nbsp;
                                </div>
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                <h2 class="title-hero">
                                    ...
                                    <input type="hidden" id="op" value="inserir_ug">
                                    ...
                                    <div class="form-horizontal bordered-row">
                                        <div class="row">
                                            <div class="col-md-10">
                                                ...
                                                <div class="form-group" style="margin: 2px;">
                                                    <label for="id" class="col-sm-3 control-label padding-label">ID</label>
                                                    <div class="col-sm-2 padding-field">
                                                        <input type="text" class="form-control" style="width: 100px;" maxlength="4" id="id" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group" style="margin: 2px;">
                                                    <label for="cod_tcm" class="col-sm-3 control-label padding-label">TCM</label>
                                                    <div class="col-sm-2 padding-field">
                                                        <input type="text" class="form-control" style="width: 100px;" maxlength="7" id="cod_tcm" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group" style="margin: 2px;">
                                                    <label for="cnpj" class="col-sm-3 control-label padding-label">CNPJ</label>
                                                    <div class="col-sm-3 padding-field">
                                                        <input type="text" class="input-mask form-control" data-inputmask="&apos;mask&apos;:&apos;99.999.999/9999-99&apos;"  style="width: 100%;" id="cnpj" value="00000000000000" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group" style="margin: 2px;">
                                                    <label for="razao_social" class="col-sm-3 control-label padding-label">Razão Social</label>
                                                    <div class="col-sm-9 padding-field">
                                                        <input type="text" class="form-control" data-parsley-maxlength="60" placeholder="Razão Social" required id="razao_social" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group" style="margin: 2px;">
