...
/*                        box-shadow: -5px -10px 30px #900, 6px 9px 15px #090;
                ...
                <div id="page-content">
                    ...
                    <div class="col-md-12" id="panel_titulo">
                        <div id="page-title">
                            <h2><strong>Tabela de Eventos</strong></h2>
                            <p><strong>Lista de eventos cadastrados para o cliente</strong></p>
                        </div>
                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4 padding-field">
                                                <div class="input-group">
                                                    <input type="text" class="form-control text lg-text" id="pesquisa" value="" placeholder="Caso necessário, informe a descrição do evento ..."/>
                                                    <div class="input-group-addon" style="padding: 0px; padding-left : 4px;">
                                                        <button id="btn_consultar" class="btn ra-round btn-primary lg-text" onclick="consultarEvento('<?php echo 'id_' . $_SESSION['acesso']['id'];?>', '<?php echo 'lg_' . $_SESSION['acesso']['us']?>')" title="Executar Consulta"><i class="glyph-icon icon-search"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-md-12" id="panel_resultado">
                        <div class="panel">
                            <div class="panel-body">
                                ...
                                <div class="box-wrapper" id="tabela-eventos">
                                    &nbsp;
                                </div>
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                <h2 class="title-hero">
                                    ...
                                    <input type="hidden" id="op" value="inserir_evento">
                                    ...
                                    <div class="form-horizontal bordered-row">
                                        <div class="row">
                                            <div class="col-md-10">
                                                ...
                                                <div class="form-group" style="margin: 2px;">
                                                    <label for="id_evento" class="col-sm-3 control-label padding-label">ID Evento</label>
                                                    <div class="col-sm-2 padding-field">
                                                        <input type="text" class="form-control" style="width: 100px;" maxlength="4" id="id_evento" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group" style="margin: 2px;">
                                                    <label for="codigo" class="col-sm-3 control-label padding-label">Rubrica</label>
                                                    <div class="col-sm-2 padding-field">
                                                        <input type="text" class="form-control" style="width: 100px;" maxlength="3" id="codigo" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group" style="margin: 2px;">
                                                    <label for="descricao" class="col-sm-3 control-label padding-label">Descrição</label>
                                                    <div class="col-sm-9 padding-field">
                                                        <input type="text" data-parsley-maxlength="40" placeholder="Descrição..." required class="form-control" id="descricao" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group" style="margin: 2px;">
                                                    <label for="tipo" class="col-sm-3 control-label padding-label">Grupo</label>
                                                    <div class="col-sm-9 padding-field">
                                                        <select class="form-control chosen-select" id="tipo" style="width: 100%;" disabled>
                                                            <option value="N" class="optionChild">Selecione o tipo</option>
                                                            <option value="V" class="optionChild">Vencimentos</option>
                                                            <option value="D" class="optionChild">Descontos</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group" style="margin: 2px;">
                                                    <label for="tipo_lancamento" class="col-sm-3 control-label padding-label">Tipo de lançamento</label>
                                                    <div class="col-sm-9 padding-field">
                                                ...
                                                <div class="form-group" style="margin: 2px;">
                                                    ...
                                                    <div class="col-sm-6 padding-field">
                                                        <div class="checkbox checkbox-primary">
                                                            <label>
                                                                <input class="custom-checkbox" type="checkbox" name="sem_uso" id="sem_uso" value="S" disabled>
                                                                Sem uso
                                                            </label>
                                                        </div>
                                                    </div>
